...
class LandingPage2 extends StatefulWidget {
  ...
  LandingPage2({this.matchData});
  @override
  _LandingPage2State createState() => _LandingPage2State();
}

class _LandingPage2State extends State<LandingPage2> {
  bool _hasPreferences = true; // Simulate whether the user has preferences or not
  int _currentIndex = 0;
  ...
  final List<Map<String, dynamic>> _matches = [
    {
      'image': 'assets/W4.jpg',
      'name': 'Dylan Villa',
      'characteristics': ['Male', 'Yoga', 'Outdoor activity Nightlife', 'Developer'],
      'gender': 'Male',
      'lgbtq': "No",
      'disability': "Yes",
      'linkedIn':"https://www.linkedin.com/in/adithya-harish/"
    },

    {
      'image': 'assets/W5.jpg',
      'name': 'Tony Thomas',
      'characteristics': ['Male', 'Professional networking events', 'Loves Group Activities'],
      'gender': 'Male',
      'lgbtq': "Yes",
      'disability': "Yes",
      'linkedIn':"https://www.linkedin.com/in/swapnilsingh25/"
    },
    {
      'image': 'assets/W1.jpg',
      'name': 'Jill Mcintyre',
      'characteristics': ['Female', 'Software Engineer', 'Loves Badminton'],
      'gender': 'Female',
      'lgbtq': "No",
      'disability': "false",
      'linkedIn':"https://www.linkedin.com/in/gayatri-bhatambarekar/"
    },
    {
      'image': 'assets/W2.jpg',
      'name': 'Ashley Clayton',
      'characteristics': ['Female', 'Product Manager at Facebook', 'Sports'],
      'gender': 'Female',
      'lgbtq': "No",
      'disability': "Yes",
      'linkedIn':"https://www.linkedin.com/in/sahana-bhaskar/"
    },
    {
      'image': 'assets/W3.jpg',
      'name': 'Penny Gordon',
      'characteristics': ['Female', 'Technology and Coding', 'Enjoys Hiking'],
        'gender': 'Female',
      'lgbtq': "No",
      'disability': "false",
      'linkedIn':"https://www.linkedin.com/in/swatika-mohapatra-74b631292/"
    },
  ];
